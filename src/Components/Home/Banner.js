            ...
            <div className="banner min-h-screen  grid grid-cols-1 lg:grid-cols-2 auto-cols-max">
                ...
                <div className=' h-full flex items-center bg-slate-900 lg:bg-transparent pb-10'>
                    <div>
                        ...
                        <button className='download-resume-button text-white font-medium text-lg border-2 border-yellow-400 rounded-full pl-5 mt-5 flex items-center mx-auto'><a href="https://drive.google.com/file/d/11Ybs2FGI18odplHrY_8NJeXxHRDfwXp2/view?usp=sharing" download="Md-Kashem-Resume.pdf" target={'_blank'}>Download Resume</a>
